(function() {
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      var str = _.reduce(argsArray, function(total, val) { return total + val; }, "");
      if (storage.hasOwnProperty(str))
        return storage[str];
      else
        return storage[str] = func.apply(null, argsArray);
    };
  };
  ...
  _.shuffle = function(array) {
    ...
    _.each(newArray, function(val, index) {
      var random = Math.floor(Math.random() * index + 1);
      var temp = newArray[random];
      newArray[random] = val;
      newArray[index] = temp;
    });
    return newArray;
